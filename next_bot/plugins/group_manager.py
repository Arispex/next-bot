...
ADD_USAGE = "格式错误，正确格式：添加身份组 [name]"
DELETE_USAGE = "格式错误，正确格式：删除身份组 [name]"
INHERIT_USAGE = "格式错误，正确格式：继承身份组 [a] [b]"
ADD_PERM_USAGE = "格式错误，正确格式：添加身份组权限 [name] [权限名称]"
REMOVE_PERM_USAGE = "格式错误，正确格式：删除身份组权限 [name] [权限名称]"
